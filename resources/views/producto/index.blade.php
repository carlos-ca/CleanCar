@extends('adminlte::Layouts.app')
    ...
    <div class="container">
        <div class="row">            
            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-header">Productos de Lavado y Aspirado</div>
                    <div class="card-body">
                        <a href="{{ url('/producto/create') }}" class="btn btn-info" title="Add New Producto">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>#</th><th>Nombre</th><th>Precio</th><th>#Piezas</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($producto as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->nombre }}</td><td>{{ $item->precio }}</td><td>{{ $item->piezas }}</td>
                                        <td>
